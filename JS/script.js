...
// Invert logo to make it visible in each sektion
 ...
 window.addEventListener("scroll", function() {
     ...
     if (scroll > distFromTop && scroll < distFromTop2) {
         ...
         document.querySelector(".findtickets-btn").style.color = "black";
         document.querySelector(".findtickets-btn").style.border = "3px solid black";
        ...
        document.querySelector(".findtickets-btn").style.color = "white";
        document.querySelector(".findtickets-btn").style.border = "3px solid white";
